...
namespace ConsoleApp2
{
    class ScreenText
    {
        ...
        public void load(int width, int height)
        {
            ...
            projection = Matrix4.CreatePerspectiveFieldOfView(MathHelper.DegreesToRadians(45f), width / (float)height, 0.1f, 5000.0f);
        ...
        public void DrawText(float x, float y)
        {
            ...
            model *= Matrix4.CreateTranslation(x * 1.0f, y * 1.0f, 1 * 5.0f);
